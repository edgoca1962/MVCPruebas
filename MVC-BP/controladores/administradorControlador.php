	...
	class administradorControlador extends administradorModelo{
		...
		public function agregar_administrador_controlador(){
			...
			if ($this->password1!=$this->password2) {
				...
				$this->consulta1=mainModel::ejecutar_consulta_simple("SELECT AdminDNI FROM admin WHERE AdminDNI = '$this->dni'");
				if ($this->consulta1->rowCount()>=1) {
					...
					if ($this->email!="") {
						$this->consulta2=mainModel::ejecutar_consulta_simple("SELECT CuentaEmail FROM cuenta WHERE CuentaEmail = '$this->email'");
					...
					if ($this->ec>=1) {
						...
						$this->consulta3=mainModel::ejecutar_consulta_simple("SELECT CuentaUsuario FROM cuenta WHERE CuentaUsuario = '$this->usuario'");
						if ($this->consulta3->rowCount()>=1) {
							...
							$this->consulta4=mainModel::ejecutar_consulta_simple("SELECT id FROM cuenta");
