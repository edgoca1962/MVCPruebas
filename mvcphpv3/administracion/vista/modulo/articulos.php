...
<div id="seccionArticulos" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
	...
	<div id="agregarArtículo">
		...
		<div id="arrastreImagenArticulo">
			<div id="imagenArticulo"><img src="vista/img/articulos/landscape01.jpg" class="img-thumbnail"></div>
		</div>
	...
	<ul id="editarArticulo">
		...
		<li>
			...
			<img src="vista/img/articulos/landscape02.jpg" class="img-thumbnail">
			<h1>Lorem Ipsum</h1>
		...
		<li>
			...
			<div id="editarImagen"><span class="fa fa-times"></span><img src="vista/img/articulos/landscape03.jpg" class="img-thumbnail"></div>
...
<div id="articulo1" class="modal fade">
	...
	<div class="modal-dialog modal-content">
		...
		<div class="modal-body" style="border:1px solid #eee">
			...
			<img src="vista/img/articulos/landscape02.jpg" width="100%" style="margin-bottom:20px">
