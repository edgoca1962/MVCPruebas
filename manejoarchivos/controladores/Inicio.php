...
class Inicio extends InicioModelo
{
    ...
    public function get_rutas_proyecto()
    {
        if ($this->get_rutas_proyecto_modelo()) {
            ...
            $this->img_banners = $this->rutas_proyecto["dominio"]["ruta"] . $this->rutas_proyecto["img_banners"]["ruta"];
        } else {
            $this->rutas_proyecto = null;
        }
    }
    public function get_imagenes_slide()
    {
    }
}
