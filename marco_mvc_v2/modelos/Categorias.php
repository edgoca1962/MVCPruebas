<?php
class CategoriasModelo extends BaseLibreria
{
    private $banner;
    ...
    protected function get_palabras_claves_modelo($categoria)
    {
        $this->consulta_base_datos = $this->conectar()->prepare("SELECT * FROM palabras_claves WHERE categoria = :valor");
    ...
    protected function get_anuncios_modelo($categoria)
    {
        $this->consulta_base_datos = $this->conectar()->prepare("SELECT * FROM anuncios WHERE pagina_anuncio = :valor");
        $this->consulta_base_datos->execute([":valor" => 'categorias']);
    ...
    protected function get_banner_modelo()
    {
        ...
        $this->banner = $this->consulta_base_datos->fetch(PDO::FETCH_ASSOC);
