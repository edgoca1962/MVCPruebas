                ...
                <div class="col-12 col-md-8 col-lg-9 p-0 pr-lg-5">
                    ...
                    <nav aria-label="paginacion">
                        <ul class="pagination justify-content-center">
                            <li class="page-item <?= ($controlador->get_atributo('pagina_actual') <= 1) ? 'disabled' : ''; ?>"><a class="page-link" href="<?= $plantilla->get_atributo('ruta_dominio') . $controlador->get_atributo('ruta_amigable_paginacion'); ?>1">Primera</a></li>
                            <li class="page-item <?= ($controlador->get_atributo('pagina_actual') <= 1) ? 'disabled' : ''; ?>"><a class="page-link" href="<?= $plantilla->get_atributo('ruta_dominio') . $controlador->get_atributo('ruta_amigable_paginacion') . ($controlador->get_atributo('pagina_actual') - 1); ?>" aria-label="Anterior"><span aria-hidden="true">&laquo;</span></a></li>
                            ...
                            <li class="page-item <?= ($controlador->get_atributo('pagina_actual') >= $controlador->get_atributo('total_paginas')) ? 'disabled' : ''; ?>">
                                <a class="page-link" href="<?= $plantilla->get_atributo('ruta_dominio') . $controlador->get_atributo('ruta_amigable_paginacion') . ($controlador->get_atributo('pagina_actual') + 1); ?>" aria-label="Siguiente"><span aria-hidden="true">&raquo;</span> </a></li>
                            <li class="page-item <?= ($controlador->get_atributo('pagina_actual') >= $controlador->get_atributo('total_paginas')) ? 'disabled' : ''; ?>"><a class="page-link" href="<?= $plantilla->get_atributo('ruta_dominio') . $controlador->get_atributo('ruta_amigable_paginacion') . $controlador->get_atributo('total_paginas'); ?>">Última</a></li>
                        </ul>
                    </nav>
                </div>
                <!-- COLUMNA DERECHA -->
